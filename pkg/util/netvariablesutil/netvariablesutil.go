...
func LoadCniConfig(netVariables *objects.NetVariables, bytes []byte) error {
...
func LoadEnvVariables(netVariables *objects.NetVariables) {
...
func MountNetNSIfNeeded(netVariables *objects.NetVariables) (string, error) {
